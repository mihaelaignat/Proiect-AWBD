...
public class UserProfileControllerTest {
    ...
    // 1. Test Listare (Rezolvă NullPointerException prin PageImpl)
    @Test
    ...
    // 3. Test Formular Update (Caz de succes)
    @Test
    @WithMockUser(authorities = "ADMIN")
    ...
    // 4. Test Salvare Succes (Rezolvă 403 prin csrf())
    @Test
    @WithMockUser(authorities = "ADMIN")
    ...
    // 5. Test Salvare Eroare - Lipsă User (Acoperă ramura IF de validare)
    @Test
    @WithMockUser(authorities = "ADMIN")
    ...
    // 6. Test Ștergere (Acoperă logica de decuplare @OneToOne)
    @Test
    @WithMockUser(authorities = "ADMIN")
    public void testDeleteProfile() throws Exception {
        ...
        // Verificăm că s-a rupt legătura și s-a șters profilul
