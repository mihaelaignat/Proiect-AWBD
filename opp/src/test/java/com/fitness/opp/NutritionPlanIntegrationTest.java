...
public class NutritionPlanIntegrationTest {
    ...
    @BeforeEach
    void setup() {
        // Configurăm ViewResolver-ul pentru a recunoaște redirect-urile și numele paginilor tale
    ...
    void testListPlans() throws Exception {
        // Creăm un plan pentru a popula lista
    ...
    void testShowFormForUpdate() throws Exception {
        ...
        // Folosim param("planId", ...) pentru că în Controller ai @RequestParam("planId")
    ...
    void testDeletePlan() throws Exception {
        ...
        // Atenție: Ruta este /nutrition/delete?planId=X
